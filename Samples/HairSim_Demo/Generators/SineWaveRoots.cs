...
[CreateAssetMenu]
public class SineWaveRoots : ScriptableObject, HairAssetBuilder.IRootGenerator
{
	...
	public unsafe bool GenerateRoots(in HairAssetBuilder.GeneratedRoots roots)
	{
		...
		for (int i = 0; i != roots.strandCount; i++)
		{
			...
			rootVar[i] = HairAssetBuilder.GeneratedRoots.StrandParameters.defaults;
		}
